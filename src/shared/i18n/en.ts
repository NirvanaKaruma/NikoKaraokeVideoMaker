...
export const en = {
  ...
  textPanel: {
    ...
    songTitle: 'Song title',
    artist: 'Artist',
    extraTitle: 'Text boxes',
    extraAdd: '＋ Add text box',
    extraRemove: 'Remove selected',
    extraNone:
  ...
  exportDialog: {
    ...
    bitrateAuto: 'Auto (by resolution)',
    bitrateCustom: 'Custom',
    bitrateValue: 'Bitrate (kbps)',
    bitrateHint: 'Effective {mbps} Mbps. Auto: 720p 6M / 1080p 10M / 2K 16M / 4K 28M.',
  ...
  kf: {
    ...
    props: 'props',
    removeFrame: 'Delete this keyframe',
    addProp: '+ Add property to this frame...',
    removeProp: 'Remove property (at this frame)',
